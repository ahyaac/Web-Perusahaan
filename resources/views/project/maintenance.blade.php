...
<body class="bg-gray-100 min-h-screen">
  ...
  <div class="max-w-6xl mx-auto px-4 py-10">
    ...
    <!-- Search Form -->
    <form action="{{ route('project/maintenance') }}" method="GET" class="mb-6">
      ...
      <table class="w-full table-auto border-collapse">
        ...
        <tbody>
          ...
          <tr class="border-t hover:bg-gray-100 text-center">
            ...
            <td class="px-4 py-2">
              <span class="inline-block px-3 py-1 rounded-full text-white text-sm {{ $project->status == 'Selesai' ? 'bg-green-500' : 'bg-red-500' }}">
                {{ $project->status }}
              </span>
            </td>
