...
<head>
  ...
  <title>Testing-Commissioning - PT. Mardika Sarana Engineering</title>
...
<body class="bg-gray-100 min-h-screen">
  ...
  <div class="max-w-6xl mx-auto px-4 py-10">
    ...
    @else
        Halaman Testing & Commissioning
    @endisset
    </h2>

    <!-- Search Form -->
    <form action="{{ route('project/testing-commissioning') }}" method="GET" class="mb-6">
