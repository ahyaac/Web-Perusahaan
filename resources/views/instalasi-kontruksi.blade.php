...
<body class="bg-gray-100">
  ...
  @include('pages/navbar')
    ...
    <div class="absolute inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
      <h1 class="text-white text-4xl font-bold">INSTALASI DAN KONSTRUKSI</h1>
    </div>
    </header>

    <div class="container mx-auto py-12 px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-8">
    <div class="md:col-span-2">
      <img src="/images/instalasi2.jpg" alt="Meeting" class="w-full rounded-lg shadow-lg">
    </div>
    <div>
    ...
    <div class="container mx-auto px-6 md:px-12 text-gray-700 text-center md:text-left mt-4 mb-8">
        ...
        Instalasi elektrikal adalah instalasi yang berhubungan dengan pasokan listrik dan komponen-komponen yang membutuhkan supply listrik. Scope bagian yang termasuk dalam lingkup pekerjaan elektrikal adalah instalasi listrik, instalasi elektronika (alarm, telephone, tata suara, CCTV, dll), penangkal petir, instalasi genset dan lain-lain. Sedangkan, konstruksi elektrikal merupakan sebuah sistem pada gedung yang terbilang cukup penting. Konstruksi elektrikal adalah pekerjaan yang memiliki sangkut paut dengan kelistrikan, seperti instalasi listrik, fire alarm, sound system, dan lain-lain.
        </span>
        </p>
        <p class="text-gray-700 text-justify">
        <span class="text-[#000000]">
        Dalam setiap proyek, kami mengutamakan inovasi, keselamatan, dan efisiensi energi. Didukung oleh teknologi terkini dan tim ahli yang berpengalaman, kami siap mewujudkan proyek impian Anda dengan hasil optimal, tepat waktu, dan sesuai anggaran. Pilih PT. Mardika Sarana Engineering untuk solusi konstruksi elektrikal dan instalasi elektrikal yang terpercaya dan profesional.
        </span>
        </p>
    </div>
