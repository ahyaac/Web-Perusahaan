    ...
    <body>
            ...
            <div style="margin-left: 250px; padding: 2rem 1.5rem; width: calc(100% - 250px);">
                <h2 class="mb-5">Dashboard</h2>
                    <form action="{{ route('admin/sertifikat/simpan') }}" method="POST" enctype="multipart/form-data" class="p-4 bg-white rounded shadow-sm">
                        @csrf
                        <div class="row mb-3">
                            <div class="col">
                            ...
                            <div class="col">
                                <label for="dokumen_sertifikat">Gambar Sertifikat</label>
                                <input type="file" name="dokumen_sertifikat" id="dokumen_sertifikat" class="form-control" required>
                            </div>
                        </div>
