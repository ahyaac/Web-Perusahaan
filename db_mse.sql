...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2025 at 06:09 AM
...
(15, 'Amelia Dianita Puspitasari', 9, '2025-06-12', '2025-05-24', '1749693746_gambar struktr_pages-to-jpg-0001.jpg', 'Surabaya', 'sma', 'perempuan', 'tetap', '3578036912970002', '1997-12-29', '2025-01-06'),
...
(45, 'hh', 13, '2025-06-12', '2025-06-12', '1749699162_1748092371_woman.png', 'Surabaya', 'strata-1', 'laki-laki', 'tetap', '09', '2000-08-08', '2022-08-08');
...
(287, 'pembangunan', '0', '2020-02-02', '2020-02-02', 'Selesai', 7, 1, 'PT. Schneider Electric', 'RIAU - KABUPATEN KAMPAR', '2025-06-12', '2025-06-12', '0', '1200000.00', NULL, 'Jakarta', '-', 5);
...
(2, 'ISO 45001 : 2015 DCS-HSM231519', '1749701180_ISO 45001  2015 DCS-HSM231519.pdf'),
...
('M9AU41RFGQWttR2WHu5FoYqjDcQIgHAoSOadochb', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '', 1749701290);
...
CREATE TABLE `struktural` (
  ...
  `nama_struktural` varchar(200) NOT NULL,
  `gambar_struktural` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `struktural` (`id_struktur`, `nama_struktural`, `gambar_struktural`) VALUES
(5, 'struktur organisasi ', 'struktur.png');
...
--
ALTER TABLE `pekerja`
  MODIFY `id_pekerja` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `proyek`
  MODIFY `id_proyek` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;
